...
export default function CTASection({
  ...
  return (
    <Section tone="cream" className="!py-12 sm:!py-14 lg:!py-16">
      <Container>
        <Reveal>
          <div className="relative overflow-hidden rounded-[1.75rem] bg-brand-ink px-6 py-10 text-center sm:px-10 sm:py-12 lg:px-12 lg:py-14">
            ...
            <h2 className="relative mt-3 font-display text-[clamp(1.85rem,4vw,2.75rem)] font-bold tracking-tight text-white">
              {title}
            </h2>
            ...
            <div className="relative mt-6 flex flex-wrap justify-center gap-3">
              <MagneticButton>
                <Button
                  to={primaryTo}
                  variant="soft"
                  className="!rounded-full !px-8 !py-3.5 !text-base !shadow-[0_0_36px_rgba(45,212,191,0.22)]"
                  icon
                >
                  {primaryLabel}
                </Button>
