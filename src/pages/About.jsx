...
export default function About() {
  return (
    <>
      <SEO
        title="About Us — Web Agency for Business & Education"
        description="About SiOn Tech Solutions — founded in 2025. Custom websites, portals, redesign and maintenance for businesses, colleges and schools across India and worldwide."
        path="/about"
      />
